...
\renewcommand\footnotemark{\addtocounter{footnote}{-1}}

% Abbreviated footnote commands for \footnotetext command
\newcommand\fntalt[1]{\footnotetext{\textsc{alt} #1}\stepcounter{footnote}}
\newcommand\fntca[2]{\footnotetext{\textsc{ca} #1 (#2)}\stepcounter{footnote}}
\newcommand\fntcf[1]{\footnotetext{cf.\ #1}\stepcounter{footnote}}
\newcommand\fnted[1]{\footnotetext{\textsc{ed} #1}\stepcounter{footnote}}
\newcommand\fntheb[2]{\footnotetext{\textsc{heb} \Hebrew{#1} #2}\stepcounter{footnote}}
\newcommand\fnthalot[1]{\footnotetext{\textsc{halot} #1}\stepcounter{footnote}}
\newcommand\fnthalotu[1]{\footnotetext{\textsc{halotu} #1}\stepcounter{footnote}}
\newcommand\fntie[1]{\footnotetext{\textsc{ie} #1}\stepcounter{footnote}}
\newcommand\fntlit[1]{\footnotetext{\textsc{lit} #1}\stepcounter{footnote}}
\newcommand\fntylt[1]{\footnotetext{\textsc{ylt} #1}\stepcounter{footnote}}
