...
\newcommand\peshitta{{\abbrev 𝔖}} % Source Code Pro messes up the appearance, but it's correct.
...
% This is currently not working because there are some places where there are more than 26 footnotes on a page.
% \renewcommand{\thefootnote}{\textit\alph{footnote}}
% Also, try having the value be "\value{versecounter}\alph{footnote}" or something.
...
% To indicate when a word used in English rendering is understood from the Hebrew, but not explicitly stated. The KJV simply italicizes all such instances, but this is cleaner and more in keeping with the style of the BHS.
...
\newcommand\fntalt[1]{\footnotetext[\value{mpfootnote}]{\textsc{alt} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fntca[2]{\footnotetext[\value{mpfootnote}]{\textsc{ca} #1 (#2)}\addtocounter{mpfootnote}{1}}
\newcommand\fntcf[1]{\footnotetext[\value{mpfootnote}]{cf.\ #1}\addtocounter{mpfootnote}{1}}
\newcommand\fnted[1]{\footnotetext[\value{mpfootnote}]{\textsc{ed} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fntheb[2]{\footnotetext[\value{mpfootnote}]{\textsc{heb} \Hebrew{#1} #2}\addtocounter{mpfootnote}{1}}
\newcommand\fnthalot[1]{\footnotetext[\value{mpfootnote}]{\textsc{halot} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fnthalotu[1]{\footnotetext[\value{mpfootnote}]{\textsc{halotu} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fntie[1]{\footnotetext[\value{mpfootnote}]{\textsc{ie} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fntlit[1]{\footnotetext[\value{mpfootnote}]{\textsc{lit} #1}\addtocounter{mpfootnote}{1}}
\newcommand\fntylt[1]{\footnotetext[\value{mpfootnote}]{\textsc{ylt} #1}\addtocounter{mpfootnote}{1}}
...
% %%%%%%%%%%%%%%
\usepackage{substr}
\newcommand\vn[1]{% vn stands for verse number.
...
\newlength{\lengthe}
\setlength{\lengthe}{0.825\textwidth}

% pv stands for Poetry Verse.
% a stands for one, b two, c three, etc.
...
\let\thempfootnote\thefootnote % Makes mpfootnote the same character scheme as regular footnotes.
